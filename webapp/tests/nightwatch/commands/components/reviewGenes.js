...
exports.command = function(row, doc) {
  this
    ...
    .verify.containsText(tableCell(row, 8), checkUndefined(doc.transcripts))
    .verify.containsText(tableCell(row, 9), checkUndefined(doc.locus_type))
    .verify.containsText(tableCell(row, 10), checkUndefined(doc.locus_group))
    .verify.containsText(tableCell(row, 11), checkUndefined(doc.hgnc_id))
  ;
